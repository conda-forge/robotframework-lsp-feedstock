...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/robotframework-lsp-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10625&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/robotframework-lsp-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `robotframework-lsp` can be installed with:

```
conda install robotframework-lsp
```

It is possible to list all of the versions of `robotframework-lsp` available on your platform with:
